...
This is a correlation matrix for the Study 2 variables. First, I dummy coded whether the SPR box was shown, the language, the country, and the type of phrase that was searched for. 
...
Next, you will notice there is a row with several pink boxes. It means that there is a high correlation between the SPR box popping up in the countries of the United Kingdom, the USA, Ireland, and Australia. There is not a significant correlation with the other countries.

There is also a high correlation between the SPR box popping up with the harmful phrase searches.
